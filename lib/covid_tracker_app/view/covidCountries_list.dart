                            ...
                            itemBuilder: (context, index){
                              return Shimmer.fromColors(
                                  ...
                                  child: Column(
                                    children: [
                                      ListTile(
                                        title: Container(height: 10, width: 80, color: Colors.black54,),
                                        subtitle: Container(height: 10, width: 80, color: Colors.black54,),
                                        leading: Container(height: 50, width: 50, color: Colors.black54,),
                                      ),
                                    ],
                                  ),
                              );

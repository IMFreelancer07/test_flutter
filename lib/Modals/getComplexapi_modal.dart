...
GetComplexapiModal getComplexapiModalFromJson(String str) => GetComplexapiModal.fromJson(json.decode(str));
String getComplexapiModalToJson(GetComplexapiModal data) => json.encode(data.toJson());
class GetComplexapiModal {
  GetComplexapiModal({
      bool? success, 
      String? message, 
      List<Data>? data,}){
  ...
  GetComplexapiModal.fromJson(dynamic json) {
  ...
  String? _message;
  List<Data>? _data;
GetComplexapiModal copyWith({  bool? success,
  String? message,
  List<Data>? data,
}) => GetComplexapiModal(  success: success ?? _success,
